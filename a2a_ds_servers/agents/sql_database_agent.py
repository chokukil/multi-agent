...
from ..parsers.parsers import SQLOutputParser  
...
from ..tools.sql import get_database_metadata
...
class SQLDatabaseAgent(BaseAgent):
    ...
    from agents import SQLDatabaseAgent
...
def make_sql_database_agent(
    ...
    --------
    ```python
    from agents import make_sql_database_agent
    import sqlalchemy as sql
    from langchain_openai import ChatOpenAI
