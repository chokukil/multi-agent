...
async def test_wrangling_quick():
    """빠른 데이터 랭글링 테스트"""
    
    print("🔧 DataWranglingAgent 빠른 테스트")
    print("="*50)
    ...
    try:
        async with httpx.AsyncClient(timeout=90.0) as httpx_client:
            ...
            test_message = "간단한 데이터 랭글링을 해주세요."
...
if __name__ == "__main__":
    success = asyncio.run(test_wrangling_quick())
    if success:
        print(f"\n🎉 요청 전송 완료!")
