...
async def test_eda_tools_quick():
    """빠른 EDA Tools 테스트"""
    
    print("📊 EDAToolsAgent 빠른 테스트")
    print("="*50)
...
if __name__ == "__main__":
    success = asyncio.run(test_eda_tools_quick())
    if success:
        print(f"\n🎉 요청 전송 완료!")
